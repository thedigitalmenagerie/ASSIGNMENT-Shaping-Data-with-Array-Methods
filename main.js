...
document
  ...
  .addEventListener("keypress", keyPressEvent => {
    if (keyPressEvent.charCode === 13) {
      ...
      <section>
      ${foundBusinesses.addressCity},
      ${foundBusinesses.addressStateCode}
      ${foundBusinesses.addressZipCode}
      </section>`;
    }
  });
...
businesses.forEach(business => {
  ...
  outEl.innerHTML += `<h2>${business.companyName} ($${totalOrders})</h2>
      <section>
...
document
  ...
  .addEventListener("keypress", keyPressEvent => {
    if (keyPressEvent.charCode === 13) {
      ...
      paEl.innerHTML = `<h3>${foundAgent.purchasingAgent.nameFirst} ${foundAgent.purchasingAgent.nameLast}</h3
      <section>
...
const paEl = document.querySelector('#purchasingAgent')
paEl.innerHTML += `<h2>Purchasing Agents</h2>`;
businesses.forEach(business => {
  businesses.map(business => {
    return business.purchasingAgent
  })
           paEl.innerHTML += `<h3>${business.purchasingAgent.nameFirst} ${business.purchasingAgent.nameLast}</h3
           <section>
